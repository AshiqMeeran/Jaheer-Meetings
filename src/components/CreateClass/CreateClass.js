        ...
        {showForm ? (
          ...
          <>
            <div className="class__title">
              Using Jareer-Meetings at a school with students?
            </div>
            <DialogContent className="class__content">
              <p className="class__text">
                ...
                account before you can use Jareer-Meetings
              ...
              <p>
                ...
                cannot use Jareer-Meetings at a school with personal accounts.
              </p>
              ...
              <div className="class__checkboxWrapper">
                ...
                <p>
                  ...
                  Jareer-Meetings at a school with students
                </p>
              </div>
            </DialogContent>
            <DialogActions>
